    ...
    def __init__(
        ...
        **fsdp_kwargs,
        ...
        self.module = nn.Sequential(
            _maybe_device(nn.Linear(8, 4), move_to_device),
            _maybe_wrap(
                nn.Sequential(
                    _maybe_wrap(_maybe_device(nn.Linear(4, 16), move_to_device)),
                    _maybe_device(nn.Linear(16, 16), move_to_device),
                ),
            ),
            _maybe_wrap(_maybe_device(nn.Linear(16, 4), move_to_device)),
            _maybe_device(nn.Linear(4, 8), move_to_device),
        )
    ...
    def __init__(
        ...
        **fsdp_kwargs,
        ...
        self.module = nn.Sequential(
            ...
            _maybe_wrap(
                nn.Sequential(
                    _maybe_device(nn.Linear(16, 4), move_to_device),
                    _maybe_device(nn.Linear(4, 8), move_to_device),
                ),
            ),
        )
...
class MixtureOfExperts(NestedWrappedModule):
    def __init__(
        ...
        **fsdp_kwargs,
        ...
        d_shared = 12
        d_input = 8
        expert = _maybe_device(nn.Linear(d_expert, d_shared), self.move_to_device)
        ...
        shared = _maybe_device(nn.Linear(d_shared, d_expert), self.move_to_device)
        ...
        self.module = nn.Sequential(
            _maybe_device(nn.Linear(d_input, d_shared), self.move_to_device),
            shared,
            expert,
            _maybe_device(nn.Linear(d_shared, d_input), self.move_to_device),
        )
